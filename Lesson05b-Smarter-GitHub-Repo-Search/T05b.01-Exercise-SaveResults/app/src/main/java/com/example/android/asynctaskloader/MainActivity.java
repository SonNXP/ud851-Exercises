...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String SEARCH_RAW_JSON ="search";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            String searchResult = savedInstanceState.getString(SEARCH_RAW_JSON);
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        String searchUrl = (String) mUrlDisplayTextView.getText();
        outState.putString(QUERY_URL, searchUrl);
        String searchResult = (String) mSearchResultsTextView.getText();
        outState.putString(SEARCH_RAW_JSON, searchResult);
    }
}