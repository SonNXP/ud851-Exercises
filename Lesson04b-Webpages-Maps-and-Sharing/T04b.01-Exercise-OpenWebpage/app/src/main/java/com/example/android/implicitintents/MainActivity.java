...
public class MainActivity extends AppCompatActivity {
    private final static String WEB_VNEXPRESS_LINK = "https://vnexpress.net/";
    ...
    public void onClickOpenWebpageButton(View v) {
        ...
        String webPageLink = WEB_VNEXPRESS_LINK;
...
//        Toast.makeText(this, "TODO: Open a web page when this button is clicked", Toast.LENGTH_SHORT).show();
    ...
    public void openWebPage(String webPageLink) {
        Uri uri = Uri.parse(webPageLink);
